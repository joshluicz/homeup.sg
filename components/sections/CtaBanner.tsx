...
export function CtaBanner() {
  return (
    <section aria-label="Schedule a HomeUP planning conversation" className="bg-neutral-900 py-20">
      <div className="container-page text-center">
        <FadeInUp>
          <div className="mx-auto max-w-3xl">
            <h2 className="m-0 font-display text-display-sm font-bold leading-tight tracking-tight text-neutral-50">
