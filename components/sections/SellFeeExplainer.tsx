...
const blocks = [
  {
    ...
    body: "Your fee is set when you sign — $1,999, $4,999, or $9,999 + GST depending on property type. It doesn't rise if your home sells for more.",
  },
  {
    icon: Handshake,
    title: "Same full service",
    body: "Listing, marketing, viewings, negotiation, and documentation — everything a traditional agent does, delivered by the same dedicated HomeUP team.",
  },
  {
    icon: Scale,
      ...
      <div className="container-page">
        <FadeInUp className="section-header">
          ...
          <p className="section-lead">
            ...
            flat fee — agreed upfront, with the same full-service experience.
          </p>
        </FadeInUp>
